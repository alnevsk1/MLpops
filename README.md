...
Создай аккаунт на странице регистрации. По умолчанию все пользователи получают роль `USER`.
...
Выбери модель из каталога и отправь запрос. Результат — текст или изображение в зависимости от типа модели. Каждый запрос логируется.
